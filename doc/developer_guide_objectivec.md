...
Contact us at sales@pdfsolid.com to obtain the PDFSolid Objective-C Conversion SDK.
...
You can contact us at sales@pdfsolid.com to get the PDF format conversion SDK package. The PDFSolid Conversion Objective-C SDK contains the following files:
